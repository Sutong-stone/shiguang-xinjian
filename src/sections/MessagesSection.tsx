        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="relative">
              ...
              <p className="text-[#8C7B72]/80 text-sm leading-relaxed pl-4 whitespace-pre-wrap">
                {content}
              </p>
            </div>
          </div>
...
export default function MessagesSection() {
  ...
  return (
    <section
      ...
      style={{ background: "linear-gradient(to bottom, #FFF8F0, #FDECE4)" }}
    >
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          ...
          <p className="text-sm text-[#8C7B72]/60 max-w-md mx-auto">
            写下想对宝宝说的话，这些温暖的文字将成为TA未来最珍贵的礼物
          </p>
        </motion.div>
        ...
        {isVerified ? (
          ...
          >
            <div className="bg-white/60 backdrop-blur-sm rounded-2xl p-8 shadow-soft">
              ...
              <p className="text-[#8C7B72] mb-4">
                输入访问密码后即可撰写寄语，与家人一起记录爱的留言
              </p>
              <Button
                onClick={() => setShowDialog(true)}
                className="bg-[#D4A78C] hover:bg-[#C49A7D] text-white rounded-full px-8 shadow-soft"
              >
